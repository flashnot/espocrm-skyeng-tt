Espo.define('she:views/hi-email/fields/email-address-varchar', ['views/fields/varchar', 'she:views/hi-email/fields/from-address-varchar'], function (Dep, From) {

    return Dep.extend({

        detailTemplate: 'she:hi-email/fields/email-address-varchar/detail',

        editTemplate: 'she:hi-email/fields/email-address-varchar/edit',

        emailAddressRegExp: /([a-zA-Z0-9._-]+@[a-zA-Z0-9._-]+\.[a-zA-Z0-9._-]+)/gi,

        listLinkTemplate: 'she:hi-email/fields/to/list-link',
